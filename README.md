...
基于 BERT 中文预训练模型的电话诈骗检测系统，受 [Fraud-R1 (ACL 2025)](https://aclanthology.org/2025.findings-acl.226/) 启发，研究"建立信任""制造紧迫感""情感操纵"三类社会工程策略对模型检测能力的干扰，并通过课程学习（Curriculum Learning）提升鲁棒性。

## 核心特点

- **双任务分类**：二分类（是否诈骗）+ 七分类（诈骗类型识别）
...
> **发现**：诈骗类型识别在增强测试集上性能明显下降（组合增强 F1 下降约 10%），说明社会工程策略对细粒度检测构成显著挑战。
